      ...
      <div className="container mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="font-pretendard text-sm text-gray-300">프랑스 파리에서 15년간 현지 베이커리에서 경력을 쌓은 뒤 빵답게의 첫 번째 오븐을 열었습니다.</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="font-pretendard text-sm text-gray-300">전통 제과와 현대적 기법을 접목시킨 디저트로 빵답게의 특별한 케이크와 타르트를 책임지고 있습니다.</p>
              </div>
            </motion.div>
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="font-pretendard text-sm text-gray-300">식품 영양학 전문가로서 건강하고 맛있는 빵답게의 신제품 개발과 품질 관리를 담당합니다.</p>
              </div>
            </motion.div>
          </div>
        </div>
        ...
        >
          <h2 className="font-montserrat text-3xl md:text-4xl font-bold mb-6">
            빵답게의 <span className="bg-gradient-to-r from-[#A78BFA] to-[#EC4899] text-transparent bg-clip-text">철학</span>, 직접 맛보세요
          </h2>
