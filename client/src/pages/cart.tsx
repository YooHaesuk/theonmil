      ...
      <div className="container mx-auto px-4">
        ...
        {cartItems.length === 0 ? (
          <motion.div variants={fadeIn} className="text-center py-12">
            <div className="text-6xl mb-6 bg-gradient-to-r from-primary to-accent text-transparent bg-clip-text">
              <i className="fa-solid fa-shopping-cart"></i>
            </div>
            <p className="text-xl mb-8 font-montserrat text-foreground">장바구니가 비어있습니다</p>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
            ...
            >
              <div className="bg-secondary rounded-lg shadow-md overflow-hidden mb-6 border border-border">
                <div className="p-6 bg-secondary border-b border-border">
                  <div className="flex justify-between items-center">
                    <h2 className="font-montserrat text-xl font-semibold text-foreground">
                      상품 목록 <span className="bg-gradient-to-r from-primary to-accent text-transparent bg-clip-text">({cartItems.length})</span>
                    </h2>
                    <button
                      onClick={emptyCart}
                  ...
                  {cartItems.map(item => (
                    ...
                    >
                      ...
                      <div className="flex-grow">
                        <Link href={`/products/${item.id}`} className="font-montserrat text-lg font-semibold text-foreground hover:bg-gradient-to-r hover:from-primary hover:to-accent hover:text-transparent hover:bg-clip-text transition-colors">
                          {item.nameKorean}
                        </Link>
                        <p className="font-montserrat text-sm text-muted-foreground">{item.name}</p>
                        <p className="font-montserrat font-semibold text-muted-foreground mt-1">
                      ...
                      <div className="flex items-center">
                        <button
                          ...
                          className="w-8 h-8 rounded-full bg-background text-foreground border border-border flex items-center justify-center hover:bg-muted transition-colors"
                        >
                          <i className="fa-solid fa-minus text-sm"></i>
                        </button>
                        <span className="w-12 text-center font-montserrat text-foreground">{item.quantity}</span>
                        <button
                          onClick={() => updateQuantity(item.id, item.quantity + 1)}
                          className="w-8 h-8 rounded-full bg-background text-foreground border border-border flex items-center justify-center hover:bg-muted transition-colors"
                        >
              ...
              <div className="flex justify-between">
                <Link href="/products" className="font-montserrat text-sm text-muted-foreground hover:text-foreground transition-colors flex items-center">
            ...
            >
              <div className="bg-secondary rounded-lg shadow-md overflow-hidden sticky top-24 border border-border">
                <div className="p-6 bg-secondary border-b border-border">
                  <h2 className="font-montserrat text-xl font-semibold text-foreground">
                    주문 <span className="bg-gradient-to-r from-primary to-accent text-transparent bg-clip-text">요약</span>
                  </h2>
                </div>
                ...
                <div className="p-6">
                  ...
                  <div className="border-t border-border pt-4 mb-6">
                    <div className="flex justify-between">
                      <span className="font-pretendard font-medium text-muted-foreground">총 결제 금액</span>
                  ...
                  <Link href="/checkout" className="w-full bg-gradient-to-r from-primary to-accent hover:opacity-90 text-primary-foreground font-medium py-3 px-4 rounded-full text-center transition-all duration-300 font-montserrat hover:shadow-lg hover:shadow-primary/20 flex items-center justify-center">
