...
const HeroSection = () => {
  ...
  return (
    <section className="relative h-screen flex items-center text-foreground overflow-hidden">
      ...
      <div className="absolute inset-0 bg-background">
        ...
        <div className="absolute inset-x-20 top-[40%] bg-gradient-to-r from-transparent via-primary to-transparent h-[2px] w-3/4 blur-sm"></div>
        <div className="absolute inset-x-20 top-[40%] bg-gradient-to-r from-transparent via-accent to-transparent h-px w-3/4"></div>
      ...
      >
        ...
        >
          <h1 className="text-4xl md:text-6xl font-montserrat font-bold mb-4">
            <motion.span
              className="bg-gradient-to-r from-primary to-accent text-transparent bg-clip-text block"
          ...
          <motion.p
            className="font-pretendard text-base md:text-xl mb-8 text-muted-foreground"
            initial={{ opacity: 0 }}
            animate={{ opacity: 1 }}
      ...
      <motion.div
        ...
        whileHover={{ y: 5 }}
      >
        <i className="fa-solid fa-chevron-down text-foreground text-2xl"></i>
      </motion.div>
    </section>
  );
};
