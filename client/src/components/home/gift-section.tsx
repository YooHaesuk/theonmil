...
const GiftSection = () => {
  return (
    <section id="gifts" className="py-20 bg-[#F5F3EF] overflow-hidden">
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center">
          ...
          >
            ...
            <p className="font-maruburi text-lg text-[#333333] mb-6">
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex items-start">
                ...
                <span className="font-pretendard text-[#333333]">원하는 날짜에 정확한 배송</span>
              </li>
              <li className="flex items-start">
                <i className="fa-solid fa-check text-[#D4AF37] mt-1 mr-3"></i>
                <span className="font-pretendard text-[#333333]">전문 플로리스트가 준비한 신선한 꽃다발</span>
              </li>
              <li className="flex items-start">
                <i className="fa-solid fa-check text-[#D4AF37] mt-1 mr-3"></i>
                <span className="font-pretendard text-[#333333]">고급스러운 패키지와 리본 포장</span>
              </li>
              <li className="flex items-start">
                <i className="fa-solid fa-check text-[#D4AF37] mt-1 mr-3"></i>
                <span className="font-pretendard text-[#333333]">직접 작성한 손글씨 메시지 카드 동봉</span>
              </li>
            </ul>
            <Link href="/products?category=gift" className={buttonClasses.primary}>
              선물 세트 보기
            </Link>
          </motion.div>
          ...
          >
            ...
            />
            <motion.div 
              className="absolute -top-6 -left-6 bg-white p-4 rounded-lg shadow-lg hidden md:block"
