...
export function BakeryHeroGeometric() {
  ...
  return (
    <div className="relative min-h-screen w-full flex flex-col justify-between pb-16 overflow-hidden bg-secondary" style={{ maxWidth: '100vw' }}>
      {/* 배경 요소들 */}
      <div className="absolute inset-0 z-0 overflow-hidden">
        ...
        {/* 크로와상 - 왼쪽 하단 */}
        <motion.div
          className="absolute left-[5%] bottom-[25%] z-10"
        ...
        >
          <img
            src={croissantImage}
            alt="크로와상"
            className="w-[180px] h-[180px] md:w-[300px] md:h-[300px] object-contain brightness-75"
          />
        </motion.div>
        ...
        >
          <img
            src={croissantImage}
            alt="크로와상"
            className="w-[200px] h-[200px] md:w-[350px] md:h-[350px] object-contain brightness-75"
          />
        </motion.div>

        {/* 바게트 - 오른쪽 하단 */}
        <motion.div
          className="absolute right-[15%] bottom-[20%] z-10"
        ...
        >
          <img
            src={baguetteImage}
            alt="바게트"
            className="w-[120px] h-[120px] md:w-[200px] md:h-[200px] object-contain brightness-75"
          />
        </motion.div>
        ...
        >
          <img
            src={baguetteImage}
            alt="바게트"
            className="w-[150px] h-[150px] md:w-[250px] md:h-[250px] object-contain brightness-75"
          />
        </motion.div>
      ...
      <div className="relative z-20 w-full flex flex-col flex-grow justify-between overflow-hidden">
        ...
        <div className="pt-40 md:pt-36 w-full overflow-hidden">
          <div className="flex flex-col items-center justify-center mx-auto px-4 sm:px-8 py-8 md:py-12 w-full max-w-[800px]" style={{ wordBreak: 'keep-all' }}>
            ...
            <motion.h1
              ...
              style={{ wordBreak: 'keep-all' }}
            >
              <span className="font-montserrat text-foreground">온전한 밀의 맛을 만드는</span> <br />
              <span className="font-montserrat bg-gradient-to-r from-primary to-accent text-transparent bg-clip-text">더 온밀</span>
            </motion.h1>
            <motion.p
              initial={{ opacity: 0 }}
              animate={{ opacity: 1 }}
        ...
        <div className="relative z-30 w-full max-w-md mx-auto mb-8 text-center px-4 overflow-hidden">
          ...
          >
            <Link
              href="/products"
              className="px-6 py-3 rounded-full bg-gradient-to-r from-primary to-accent text-white text-sm font-medium shadow-md hover:shadow-lg hover:shadow-primary/30 hover:scale-105 transition-all duration-300 max-w-[200px] mx-auto w-full sm:w-auto"
            >
              제품 탐색하기
            </Link>
            <Link
              href="/brand"
              className="px-6 py-3 rounded-full bg-secondary border border-border text-foreground text-sm font-medium shadow-sm hover:shadow-md hover:scale-105 hover:bg-muted transition-all duration-300 max-w-[200px] mx-auto w-full sm:w-auto"
            >
              브랜드 이야기
            </Link>
          </motion.div>
          ...
          >
            ...
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M12 4V20M12 20L18 14M12 20L6 14" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-foreground" />
              </svg>
            </motion.div>
          </motion.div>
        </div>
